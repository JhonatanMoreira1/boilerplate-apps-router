    ...
    var Fa = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        TESTING_MODULE_RUN_ALL_REQUEST: zo,
        TESTING_MODULE_RUN_REQUEST: Uo,
    ...
    var ti = __STORYBOOK_API__,
      {
        ...
        eventToShortcut: pi,
        experimental_MockUniversalStore: fi,
        experimental_UniversalStore: di,
        experimental_requestResponse: mi,
        experimental_useUniversalStore: gi,
        isMacLike: bi,
        isShortcutTaken: hi,
        keyToSymbol: Ei,
        merge: yi,
        mockChannel: Oi,
        optionOrAltSymbol: Ti,
        shortcutMatchesShortcut: _i,
