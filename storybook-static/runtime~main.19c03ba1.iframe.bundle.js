;(() => {
  ...
  ;(__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (112 === chunkId ? 'main-stories' : chunkId) +
      '.' +
      {
        112: 'b1d35033',
        207: '00865cc8',
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done)
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'boilerplate-apps-router:' + key
            ) {
              script = s
              break
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 'boilerplate-apps-router:' + key),
          (script.src = url)),
          (inProgress[url] = [done])
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkboilerplate_apps_router =
